...
// Time-series plots
    ...
    {"bdrydrugAmet1",             0, 0,1,"","Average concentration of drug A metabolite 1 on the blob boundary"},
    {"bdrydrugAmet2",             0, 0,1,"","Average concentration of drug A metabolite 2 on the blob boundary"},
    {"bdrydrugB",                 0, 0,1,"","Average concentration of drug B at the blob boundary"},
    {"bdrydrugBmet1",             0, 0,1,"","Average concentration of drug B metabolite 1 on the blob boundary"},
    {"bdrydrugBmet2",             0, 0,1,"","Average concentration of drug B metabolite 2 on the blob boundary"},
